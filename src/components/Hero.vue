    ...
    <div class="statistics">
      <div class="statistics-content">
        ...
        <div class="stats">
          ...
          <div class="counter price-stat"><p>Total Spent</p> <p>${{ priceCounter.toLocaleString() }}</p></div> 
          <div class="counter price-stat"><p>Average Ticket Cost</p> <p>${{ Math.floor(priceCounter/shows.length) }}</p></div> 
        </div>
